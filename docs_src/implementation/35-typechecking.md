...
This is to say that an interface is therefore a pair containing a human-readable name $name_i$ and the set of type-signatures that _define_ said interface.
